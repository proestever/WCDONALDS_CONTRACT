...
contract WcDonalds is ERCX {
    ...
    string private constant _ticker = "WcDon";
    ...
    constructor() ERCX("", _name, _ticker, _decimals, _totalTokens, _tokensPerNFT) {
        dataURI = "https://nftstorage.link/ipfs/bafybeiejmijhuvy2zywcwqyop73deh656s7sg5fpvoeq7xyi2g4452fapm/";
    ...
    function tokenURI(uint256 id) public view returns (string memory) {
        ...
        if (bytes(baseTokenURI).length > 0)
            ...
            string memory name = ""; // Added name variable

            if (seed <= 2) { // Extremely Rare
                image = "SPECTRAL.png";
                rarity = "Spectral";
                description = "An ethereal presence, almost impossible to find.";
                name = "Celestia, the Spectral Fast Food Princess"; // Name for the ultra rare spectral girl
            } else if (seed <= 18) { // Rarest
                image = "1.png";
                rarity = "Ultra Rare";
                description = "The most unique and rarest of them all.";
                name = "Amber, the Golden Arch Guardian";
            } else if (seed <= 34) {
                image = "2.png";
                rarity = "Super Rare";
                description = "Extremely hard to find, with unique attributes.";
                name = "Ruby, the Fry Master";
            } else if (seed <= 50) {
                image = "3.png";
                rarity = "Very Rare";
                description = "Very uncommon and sought after.";
                name = "Sapphire, the Shake Sorceress";
            } else if (seed <= 66) {
                image = "4.png";
                rarity = "Rare";
                description = "Harder to come by, with some unique features.";
                name = "Jade, the Burger Bard";
            } else if (seed <= 82) {
                image = "5.png";
                rarity = "Uncommon";
                description = "Less frequently seen, with distinctive characteristics.";
                name = "Violet, the Wrap Whisperer";
            } else if (seed <= 98) {
                image = "6.png";
                rarity = "Semi-Rare";
                description = "Not as common, with some rare elements.";
                name = "Scarlet, the Salad Sage";
            } else if (seed <= 114) {
                image = "7.png";
                rarity = "Less Common";
                description = "Somewhat unusual, with a few rare traits.";
                name = "Coral, the Condiment Conjurer";
            } else if (seed <= 130) {
                image = "8.png";
                rarity = "Common";
                description = "Regularly found, with standard attributes.";
                name = "Azure, the Soda Sylph";
            } else if (seed <= 146) {
                image = "9.png";
                rarity = "Very Common";
                description = "Frequently seen, with common features.";
                name = "Magenta, the McNugget Mystic";
            } else if (seed <= 162) {
                image = "10.png";
                rarity = "Most Common";
                description = "Common, yet still unique in its own right.";
                name = "Rose, the Happy Meal Herald";
            } else if (seed <= 178) {
                image = "11.png";
                rarity = "Abundant";
                description = "Widely available, with familiar features.";
                name = "Sienna, the Sundry Snacker";
            } else if (seed <= 194) {
                image = "12.png";
                rarity = "Plentiful";
                description = "Found in many places, easily recognizable.";
                name = "Marigold, the McFlurry Mage";
            } else if (seed <= 210) {
                image = "13.png";
                rarity = "Bountiful";
                description = "A frequent find, with no shortage of sightings.";
                name = "Lilac, the Latte Lady";
            } else { // This now covers seed > 210 up to the maximum value seed can have
                image = "14.png";
                rarity = "Ubiquitous";
                description = "Everywhere you look, there it is.";
                name = "Iris, the Ice Cream Illusionist";
            }


            string memory jsonPreImage = string(abi.encodePacked('{"name": "', name, '","description":"', description, '","external_url":"","image":"', dataURI, image));
            return string(abi.encodePacked("data:application/json;utf8,", jsonPreImage, '","attributes":[{"trait_type":"","value":"', rarity, '"}]}'));
        }
